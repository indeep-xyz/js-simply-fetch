 ...
 * @param {String} A filename of an array passed to loadFile.
 ...
 * @param {Object<String>}
 *   An object which has the key name based on filename of an array passed to loadFile.
...
SimplyFetch.prototype.fetch = function(urlSources) {
  ...
  function loadFile(urlSource){
     ...
     * @since 0.1.0
     *
     * @param {String} key - the URL source passed to #loadFile
